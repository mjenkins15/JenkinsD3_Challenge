...
//}) These closing  brackets will need to be moved 
    

    // Step 1: Parse Data/Cast as numbers
    // ==============================
    // All info is already in number format

    // Step 2: Create scale functions
    // ==============================
    var xLinearScale = d3.scaleLinear()
      .domain([20, d3.max(stateInfo, d => d.smokes)])
      .range([0, width]);
  ...
  chartGroup.append("g")
    ...
    var toolTip = d3.tip()
      ...
      .offset([80, -60])
      .html(function(d) {
        return (`${d.smokes}<br>Smokes: ${d.smokes}<br>Age: ${d.age}`);
      });
